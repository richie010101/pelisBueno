...
<body>
    ...
    <div class="rtx">
            <div class="contenidoInfo">
                 <p> shrek2</p>
                 <p> Año: 2004</p>
                 <p> Dirección: Andrew Adamson</p>
                 <p> Duración: 94 minutos</p>
                 <p> Productora: dreamworks</p>
                 <p> Sinopsis: Sinopsis: Shrek, Asno y la Princesa Fiona se enfrentan a toda una divertida aventura</p>
                 </div>
                 <?php
                 ...
                 <div class="reproductor">
                     <IFRAME SRC="https://uqload.org/embed-lmbosbm82v54.html"  MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=700 HEIGHT=470 allowfullscreen></IFRAME>
                 </div>
             </div>
             <div class="info">
                   <div class="logoB">
